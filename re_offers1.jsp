...
<div id="wrapper"> 
  <div id="container"> 
    <div id="header"> 
      <div id="logo"><br>
        ...
        Online Pro-Active Methodology Using the <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Pro-Active Methodology</font></strong></div>
    </div>
    <!-- /header -->
    <div id="navbar"> 
      <ul>
 ...
 %>
            ...
            <td width="200" bgcolor="#FBF7E1" align="center"><strong><em><font color="#FF0000" size="+1" face="Courier New">Product 
              Image:</font></em></strong><br> <br> <img src="image.jsp?product_name=<%=pid%>" height="212" width="165">
			  </td>
        </table></td>
        </tr> </table> </div>
      <!-- /intro -->
    ...
    <div id="footer"> 
      ...
      <br>
      <br>
      <strong><font color="#33CC66">  </font></strong> </div>
    <!-- /footer -->
  </div>
  <!-- /container -->
</div>
